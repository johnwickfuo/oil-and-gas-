...
<template>
    <div class="min-h-screen flex flex-col bg-cream text-charcoal">
        <a
            href="#main-content"
            class="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[60] focus:inline-flex focus:items-center focus:rounded-full focus:bg-primary focus:text-cream focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-accent"
        >
            Skip to content
        </a>
